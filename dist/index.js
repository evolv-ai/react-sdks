...
var init_esm_shims = __esm({
    "node_modules/tsup/assets/esm_shims.js": function() {}
});
...
init_esm_shims();
var defaultStore = {};
var EvolvContext = React.createContext(defaultStore);
var EvolvProvider = function(param) {
    var children = param.children, client = param.client;
    return /* @__PURE__ */ React.createElement(EvolvContext.Provider, {
        value: {
            client: client
        }
    }, children);
...
var useEvolvClient = function() {
    var client = useContext(EvolvContext);
    return client;
};
...
function useVariable(key, initialState) {
    ...
    var ref = _slicedToArray(useState2(client.evolvState[key] || initialState), 2), value = ref[0], setValue = ref[1];
...
// types/index.ts
init_esm_shims();
export { EvolvClient, EvolvContext, EvolvProvider, generateId, useEvolvClient, useVariable, withEvolv, withEvolvSSR, withEvolvServer }; /*!
 * cookie
